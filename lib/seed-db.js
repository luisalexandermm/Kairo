...
const PRODUCTS = [
  { id:'nike-air-max-270',      brand:'Nike',       name:'Air Max 270',            price:749900, tag:'Lifestyle',        shape:'s-low',  shoe_color:'#1d2733', bg:'#f3ece3', description:'Unidad Air de 32 mm en el talón, la más alta de la línea. Malla transpirable y horma fiel a la talla.',       sizes:SIZES_SHOE, colors:[{n:'Negro/Rojo',h:'#1d2733'},{n:'Blanco',h:'#e9e6df'},{n:'Azul',h:'#1d4ed8'}], stock:12, active:true, featured:true,  position:1 },
  { id:'nike-air-force-1',      brand:'Nike',       name:"Air Force 1 '07",        price:529900, tag:'Clásico',          shape:'s-low',  shoe_color:'#e4e1d8', bg:'#eef0f2', description:'El clásico de cuero de 1982. Suela de goma con pivote y amortiguación Air en la entresuela.',              sizes:SIZES_SHOE, colors:[{n:'Blanco',h:'#e4e1d8'},{n:'Negro',h:'#171a1f'},{n:'Crema',h:'#d8c9ad'}],         stock:20, active:true, featured:false, position:2 },
  { id:'nike-pegasus-41',       brand:'Nike',       name:'Air Zoom Pegasus 41',    price:669900, sale_price:599900, tag:'Running', shape:'s-low', shoe_color:'#2f6f8f', bg:'#e7f0f4', description:'Espuma ReactX y dos unidades Zoom Air para entrenamientos diarios y salidas largas.', sizes:SIZES_SHOE, colors:[{n:'Azul',h:'#2f6f8f'},{n:'Negro',h:'#1a1d22'},{n:'Verde',h:'#3f7d4c'}], stock:8, active:true, featured:false, position:3 },
  { id:'jordan-1-mid',          brand:'Jordan',     name:'Air Jordan 1 Mid',       price:759900, tag:'Icono',            shape:'s-high', shoe_color:'#a4123a', bg:'#f1e7ea', description:'Caña media con cuello acolchado, cuero en el empeine y unidad Air encapsulada. Talla fiel.',              sizes:SIZES_SHOE, colors:[{n:'Rojo/Blanco',h:'#a4123a'},{n:'Negro',h:'#16181d'},{n:'Verde',h:'#1f5c3d'},{n:'Amarillo',h:'#d9a021'}], stock:15, active:true, featured:true, position:4 },
  ...
  { id:'jordan-retro-high-og',  brand:'Jordan',     name:'Air Jordan 1 Retro High OG', price:1179900, tag:'Edición limitada', shape:'s-high', shoe_color:'#e0a12b', bg:'#f6eee0', description:'Corte alto en cuero premium, construcción fiel al modelo de 1985.', sizes:SIZES_SHOE, colors:[{n:'Mostaza',h:'#e0a12b'},{n:'Negro/Rojo',h:'#1a1a1d'},{n:'Blanco',h:'#eae7e0'}], stock:4, active:true, featured:false, position:6 },
  { id:'adidas-ultraboost',     brand:'Adidas',     name:'Ultraboost Light',       price:899900, sale_price:759900, tag:'Running', shape:'s-low', shoe_color:'#22252c', bg:'#eaeaec', description:'Espuma Light BOOST, 30% más liviana. Upper Primeknit que se ajusta al pie.', sizes:SIZES_SHOE, colors:[{n:'Negro',h:'#22252c'},{n:'Blanco',h:'#e7e5e0'},{n:'Gris',h:'#8b8f96'}], stock:10, active:true, featured:false, position:7 },
  { id:'adidas-samba-og',       brand:'Adidas',     name:'Samba OG',               price:549900, tag:'Clásico',          shape:'s-low',  shoe_color:'#17181c', bg:'#efece5', description:'Cuero suave, punta de gamuza y suela de goma color miel. La silueta baja más versátil del momento.', sizes:SIZES_SHOE, colors:[{n:'Negro',h:'#17181c'},{n:'Blanco/Verde',h:'#dedbd2'},{n:'Azul',h:'#26407a'}], stock:18, active:true, featured:true,  position:8 },
  ...
  { id:'timberland-6-inch',     brand:'Timberland', name:'Bota 6-Inch Premium',    price:1099900, tag:'Impermeable',     shape:'s-boot', shoe_color:'#b47a29', bg:'#f3ebdd', description:'Nobuk impermeable, costuras selladas y forro acolchado. La bota amarilla original de Nueva York.',        sizes:SIZES_BOOT, colors:[{n:'Trigo',h:'#b47a29'},{n:'Negro',h:'#22201d'},{n:'Café',h:'#6b4423'}], stock:5, active:true, featured:true,  position:11 },
  { id:'timberland-euro-sprint', brand:'Timberland', name:'Euro Sprint Hiker',     price:879900, tag:'Outdoor',          shape:'s-boot', shoe_color:'#5a4630', bg:'#efe9e0', description:'Bota de caña media en nobuk, suela con tracción profunda y plantilla Anti-Fatigue.',                      sizes:SIZES_BOOT, colors:[{n:'Café',h:'#5a4630'},{n:'Negro',h:'#26241f'},{n:'Trigo',h:'#c08c3c'}], stock:6, active:true, featured:false, position:12 }
];

const PROMOS = [
  { id:'promo-envio',   title:'Envío gratis desde $600.000', description:'Pedidos superiores a $600.000 enviados sin costo a toda Colombia.', badge:'Envío gratis', discount:0, scope:'Todos', active:true, position:1 },
  { id:'promo-segunda', title:'Segunda unidad al 30% off',   description:'Llevando dos pares de cualquier marca, el segundo sale con 30% de descuento.', badge:'2x ahorro', discount:30, scope:'Todos', active:true, position:2 }
];
